<?php
    ...
    if(!$firstname){
        ...
        if($createpassword !== $confirmpassword){
            $_SESSION['add-user'] = "Password don't matched";
        }else{
            // hashed password
            ...
            if(mysqli_num_rows($user_check_result) > 0){
                $_SESSION['add-user'] = "Username or Email already exit";
            }else{
                // WORK ON AVATAR
                // rename avatar
                ...
                if(in_array($extention, $allowed_files)){
                    ...
                    if($avatar['size'] < 1000000){
                        ...
                        $_SESSION['add-user'] = 'Files size too big. Should be less than 1mb';
                    }
                }else{
    ...
    if($_SESSION['add-user']){
        ...
        if(!mysqli_errno($connection)){
            ...
            $_SESSION['add-user-success'] = "New user <strong>$firstname $lastname</strong> added successfully.";
