...
<section class="dashboard">
    ...
    <?php if(isset($_SESSION['edit-post-success'])){?>
        ...
        <?php }else if(isset($_SESSION['edit-post'])){?>
        <div class="alert__message danger container">
            <p>
                <?= $_SESSION['edit-post'];
        ...
        <?php }else if(isset($_SESSION['add-post'])){?>
        <div class="alert__message danger container">
            <p>
                <?= $_SESSION['add-post'];
        ...
        <?php }else if(isset($_SESSION['add-post-success'])){?>
        <div class="alert__message success container">
            <p>
        ...
        <?php }else if(isset($_SESSION['delete-post-success'])){?>
        <div class="alert__message success container">
            <p>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="<?= ROOT_URL?>admin/" class="active"><i class="uil uil-postcard"></i><h5>Manage Post</h5></a></li>
        ...
        <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $post['title']?></td>
                        <td><a href="<?= ROOT_URL?>category_posts.php" class="category__button"><?= $category['title']?></a></td>
