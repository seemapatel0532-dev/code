...
<section class="dashboard">
        ...
        <?php }else if(isset($_SESSION['edit-category-success'])){?>
        <div class="alert__message success container">
            <p>
        ...
        <?php }else if(isset($_SESSION['edit-category'])){?>
        ...
        <?php }else if(isset($_SESSION['delete-category-success'])){?>
        <div class="alert__message success container">
            <p>
                <!-- show if edit user was successfull -->
        ...
        <?php }else if(isset($_SESSION['delete-category'])){?>
        <div class="alert__message error container">
            <p>
                <!-- show if edit user was not successfull -->
