"""
Django settings for e_ven project.
...
SECRET_KEY = 'django-insecure-z294w%n^xelr@vws^o1y6u7f)kg^p=k8vh!se%)94yfec=*xg8'
...
WSGI_APPLICATION = 'e_ven.wsgi.application'
